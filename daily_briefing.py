...
def build_briefing():
    ...
    if date_key in ("2026-04-11", "2026-04-12"):
        ...
        if date_key == "2026-05-16":
            ...
            lines.append("<a href='https://www.linkedin.com/feed/update/urn:li:activity:7463975452337156096/'>→ Dr. Tali Režun on Context Engineering</a>")
            lines.append("The practitioners who never hit limits aren't the ones on Max plans.")
            lines.append("→ They're the ones who treat context as infrastructure.")
